...
const Footer = () => {
    return (
        ...
        <footer className="bg-[#031A06] text-white">
            <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                <div>
                    <h2 className="mb-6  text-lg  font-bold  ">Company</h2>
                    <ul className="">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6  text-lg  font-bold   ">Help center</h2>
                    <ul className="">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6  text-lg  font-bold   ">Download</h2>
                    <ul className="">
                        <li className="mb-4">
            ...
            <div className="py-6 px-4 border-t-2 border-[#FDBF1D] md:flex md:items-center md:justify-between">
                <small>© 2022 Copyrights. All Rights Reserved by Mohiuddin Khan.
                </small>
